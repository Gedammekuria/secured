          ...
          <div className="split-row">
            <div className="split-image">
              <div className="image-frame">
                <img src="/assets/service/indoor-camera-1.webp" alt="Professional CCTV Systems" loading="lazy" />
      ...
      <section className="service-split cctv-bg" id="smartdoorlock-section" style={{ background: 'linear-gradient(135deg, #e3f2fd 0%, #f8faff 100%)' }}>
        <div className="container">
          <div className="split-row">
            <div className="split-image">
              <div className="image-frame">
                <img src="/assets/service/smart-doorlock.webp" alt="Smart Door Lock Systems" loading="lazy" />
                <div className="image-overlay-accent"></div>
              </div>
            </div>
            <div className="split-text">
