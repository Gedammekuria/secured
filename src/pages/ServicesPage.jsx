          ...
          <div className="split-row">
            <div className="split-image">
              <div className="image-frame">
                <img src="/assets/service/outdoor-camera-1.webp" alt="Professional CCTV Systems" loading="lazy" />
      ...
      <section className="service-split alarm-bg" id="alarm-section">
        <div className="container">
          <div className="split-row">
            ...
            <div className="split-image">
              <div className="image-frame">
                <img src="/assets/service/ajax-detector.webp" alt="Smart Alarm Systems" loading="lazy" />
      ...
      <section className="service-split cctv-bg" id="smartdoorlock-section" style={{ background: 'linear-gradient(135deg, #e3f2fd 0%, #f8faff 100%)' }}>
        <div className="container">
          <div className="split-row">
            <div className="split-image">
              <div className="image-frame">
                <img src="/assets/service/smart-doorlock-services.webp" alt="Smart Door Lock Systems" loading="lazy" />
                <div className="image-overlay-accent"></div>
              </div>
            </div>
            <div className="split-text">
